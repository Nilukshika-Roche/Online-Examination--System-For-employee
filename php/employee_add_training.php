...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $type = "training";  // As the ticket type is disabled in the form and set to "complaint"

    // Assuming a session or another method is used to retrieve the user ID
    // $user_id = $_SESSION['user_id'];  // Uncomment and modify according to your user session handling
    $user_id = $_POST['user_id'] ? $_POST['user_id']: 1;  // Placeholder for demonstration purposes; replace with actual user ID handling logic
    ...
    if ($stmt->execute()) {
        ...
        header("Location: /online_examination22/employee/view_training.php"); 
    } else {
