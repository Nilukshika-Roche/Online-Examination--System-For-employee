...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $type = "complaint";  // As the ticket type is disabled in the form and set to "complaint"
    ...
    $user_id = 2;  // Placeholder for demonstration purposes; replace with actual user ID handling logic
