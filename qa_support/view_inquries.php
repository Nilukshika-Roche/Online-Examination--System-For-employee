    ...
    <body>
      <div class="d-flex">
        <div class="menu">
          ...
          <div class="form-title">Inquiry Management</div>
        ...
        <div class="container">
          <div class="header-section">
            <div class="d-flex align-items-center">
              <div class="p-3 header-title">Quality Asuarance and complience officer</div>
          ...
          <div class="p-3 table-header">Inquiry Details</div>
                    <div class="d-flex1 justify-content-center">
                        ...
                        $sql = "SELECT Ticket_ID, Description, Type, Date, User_ID FROM Ticket WHERE Type = 'complaint' ORDER BY Ticket_ID";
                        $result = $conn->query($sql);

                        if ($result->num_rows > 0) {
                            echo "<table><tr><th>Ticket ID</th><th>Description</th><th>Type</th><th>Date</th><th>Action</th></tr>";
                            while($row = $result->fetch_assoc()) {
                                echo "<tr><td>" . $row["Ticket_ID"] . "</td><td>" . htmlspecialchars($row["Description"]) . "</td><td>" . $row["Type"] . "</td><td>" . $row["Date"] . "</td><td><a href='update_inquries.php?ticket_id=" . $row["Ticket_ID"] . "'>Update</a></td></tr>";
                            }
                            echo "</table>";
                        } else {
                            echo "0 results";
