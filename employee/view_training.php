    ...
    <body>
      <div class="d-flex">
        ...
        <div class="container">
          ...
          <div class="p-3 table-header">Training Details</div>
                    <div class="d-flex1 justify-content-center">
                        ...
                        $sql = "SELECT Ticket_ID, Description, Type, Date, User_ID FROM Ticket WHERE Type = 'training' AND User_ID = ? ORDER BY Ticket_ID";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while($row = $result->fetch_assoc()) {
                                echo "<tr><td>" . $row["Ticket_ID"] . "</td><td>" . htmlspecialchars($row["Description"]) . "</td><td>" . $row["Type"] . "</td><td>" . $row["Date"] . "</td><td><a href='update_training.php?ticket_id=" . $row["Ticket_ID"] . "'>Update</a></td></tr>";
                            }
                            echo "</table>";
                        } else {
                            echo "0 results";
