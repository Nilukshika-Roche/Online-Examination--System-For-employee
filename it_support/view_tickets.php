    ...
    <body>
      <div class="d-flex">
        ...
        <div class="container">
          ...
          <div class="p-3 table-header">Ticket Details</div>
                    <div class="d-flex1 justify-content-center">
                        ...
                        $sql = "SELECT Ticket_ID, Description, Type, Date, User_ID FROM Ticket ORDER BY Ticket_ID";
                        $result = $conn->query($sql);

                        if ($result->num_rows > 0) {
                            echo "<table><tr><th>Ticket ID</th><th>Description</th><th>Type</th><th>Date</th></tr>";
                            while($row = $result->fetch_assoc()) {
                                echo "<tr><td>" . $row["Ticket_ID"] . "</td><td>" . htmlspecialchars($row["Description"]) . "</td><td>" . $row["Type"] . "</td><td>" . $row["Date"] . "</td></tr>";
                            }
                            echo "</table>";
                        } else {
                            echo "0 results";
